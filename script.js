...
function todoHandler() {
    ...
    if (!nameRegex.test(user.name) || !ageRegex.test(user.age) || !cityRegex.test(user.city) || !numberRegex.test(user.number)) {
...
function editValues() {
    let updatedName = prompt("Enter correct Name");
    while (!nameRegex.test(updatedName)) {
        updatedName = prompt("Invalid input. Please enter correct Name");
    }

    let updatedAge = prompt("Enter correct Age");
    while (!ageRegex.test(updatedAge)) {
        updatedAge = prompt("Invalid input. Please enter correct Age");
    }

    let updatedCity = prompt("Enter correct City");
    while (!cityRegex.test(updatedCity)) {
        updatedCity = prompt("Invalid input. Please enter correct City");
    }

    let updatedNumber = prompt("Enter correct Number");
    while (!numberRegex.test(updatedNumber)) {
        updatedNumber = prompt("Invalid input. Please enter correct Number");
    }
